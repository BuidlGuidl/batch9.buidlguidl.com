...
export const Header = () => {
  ...
  return (
    <div className="sticky dark:bg-zinc-950 bg-zinc-100 lg:static top-0 navbar min-h-0 flex-shrink-0 justify-between z-20 shadow-md shadow-secondary px-0 sm:px-2">
